...
const Banner = ({ bannerData }: BannerProps) => {
  return (
    <div className="flex pt-20 items-center max-sm:text-center">
      <div className="flex flex-col lg:w-1/2 md:w-2/3 w-full max-md:items-center max-sm:backdrop-blur">
      ...
      <div className="absolute w-[250px] h-[250px] md:w-[350px] md:h-[350px] sm:w-[300px] sm:h-[300px] lg:w-[400px] lg:h-[400px] right-20 top-44">
        <Image
