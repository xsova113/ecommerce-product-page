...
const Banner = ({ bannerData }: BannerProps) => {
  return (
    <section className="md:p-10 mt-20 px-4 py-8 bg-gradient-to-br from-violet-200 via-purple-200 to-blue-200 rounded-2xl mb-14 w-full shadow-lg text-gray-700">
